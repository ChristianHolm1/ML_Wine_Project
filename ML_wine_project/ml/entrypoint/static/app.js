...
const fields = [
  {name: "fixed_acidity", label: "fixed acidity", placeholder: "0.0-10.0"},
  {name: "volatile_acidity", label: "volatile acidity", placeholder: "5.5"},
  {name: "citric_acid", label: "citric acid", placeholder: "5.5"},
  {name: "residual_sugar", label: "residual sugar", placeholder: "5.5"},
  {name: "chlorides", label: "chlorides", placeholder: "5.5"},
  {name: "free_sulfur_dioxide", label: "free sulfur dioxide", placeholder: "5.5"},
  {name: "total_sulfur_dioxide", label: "total sulfur dioxide", placeholder: "5.5"},
  {name: "density", label: "density", placeholder: "5.5"},
  {name: "pH", label: "pH", placeholder: "5.5"},
  {name: "sulphates", label: "sulphates", placeholder: "5.5"},
  {name: "alcohol", label: "alcohol", placeholder: "e.g. 7.4"}
];
